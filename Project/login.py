...
def signup_post():
    ...
    new_user = User(email=email, name=name, password=generate_password_hash(password, method='sha256'), user_type=user_type) # Hashes the password so a plaintext version isn't saved
